                ...
                <div class="card-body">
                    ...
                    <!--JIKA ROLE USER PENJUAL-->
                        <div class="row mt-2">
                            <div class="col-6">
                                <div class="card p-2">
                                    <div class="card-header text-white bg-secondary">Input Produk</div>
                            ...
                            <div class="col-6">
                                <div class="card p-2">
                                    <div class="card-header text-white bg-secondary">Report Input Produk</div>
                    ...
                    <div class="row mt-2">
                            <div class="col-6">
                                <div class="card p-2">
                                    <div class="card-header text-white bg-secondary">Input Pesanan</div>
                            ...
                            <div class="col-6">
                                <div class="card p-2">
                                    <div class="card-header text-white bg-secondary">Daftar Input Pesanan</div>
